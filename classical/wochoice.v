...
(*                                                                            *)
(* `{in <= S, P}`                                                             *)
(*     ~ the predicate `P` holds for all subsets of `S`                       *)
(*     ~ `P` has type `{pred T} -> Prop` for `T : predArgType`                *)
(*                                                                            *)
(* `maximal R z`                                                              *)
(*     ~ `z` is a maximal element for the relation `R`                        *)
(*                                                                            *)
(* `minimal R z`                                                              *)
(*     ~ `z` is a minimal element for the relation `R`                        *)
(*                                                                            *)
(* `upper_bound R A z`                                                        *)
(*     ~ for all `x` in `A`, we have `R x z`                                  *)
(*                                                                            *)
(* `lower_bound R A z`                                                        *)
(*     ~ for all `x` in `A`, we have `R z x`                                  *)
(*                                                                            *)
(* `preorder R`                                                               *)
...
(*                                                                            *)
(* `minimum_of R A z`                                                         *)
(*     ~ `z \in A /\ lower_bound A z`                                         *)
(*                                                                            *)
(* `maximum_of R A z`                                                         *)
(*     ~ `z \in A /\ upper_bound A z`                                         *)
(*                                                                            *)
(* `well_order R`                                                             *)
(*     ~ every non-empty subset has a unique minimum element                  *)
(*                                                                            *)
(* `chain R C`                                                                *)
(*     ~ the subset `C` is totally ordered                                    *)
(*     ~ `:= {in C &, total R}`                                               *)
(*                                                                            *)
(* `wo_chain R C`                                                             *)
(*     ~ `{in <= C, well_order R}`                                            *)
