...
(*                                                                            *)
(* `decreasing_fun f`                                                         *)
(*     ~ the function `f` is (strictly) decreasing                            *)
(*                                                                            *)
(* `nondecreasing_seq u`                                                      *)
(*     ~ the sequence `u` is non-decreasing                                   *)
(*                                                                            *)
(* `nonincreasing_seq u`                                                      *)
(*     ~ the sequence `u` is non-increasing                                   *)
(*                                                                            *)
(* `monotonic A f`                                                            *)
(*     ~ `{in A &, {homo f : x y / x <= y}} \/                                *)
(*       {in A &, {homo f : x y /~ x <= y}}`                                  *)
(*                                                                            *)
(* `strict_monotonic A f`                                                     *)
(*     ~ `{in A &, {homo f : x y / x < y}} \/                                 *)
(*       {in A &, {homo f : x y /~ x < y}}`                                   *)
(*                                                                            *)
(* `sigT_fun f`                                                               *)
(*     ~ lifts a family of functions `f` into a function on the               *)
(*       dependent sum                                                        *)
(*                                                                            *)
(* `prodA x`                                                                  *)
(*     ~ sends `(X * Y) * Z` to `X * (Y * Z)`                                 *)
(*                                                                            *)
(* `prodAr x`                                                                 *)
(*     ~ sends `X * (Y * Z)` to `(X * Y) * Z`                                 *)
(*                                                                            *)
(* `isSemiNorm f`                                                             *)
(*     ~ `f : K -> L` is a seminorm K is a `numDomainType`. L is a            *)
(*       `lmodType K`. The HB class is `SemiNorm`.                            *)
(*                                                                            *)
(* `isNorm f`                                                                 *)
(*     ~ `f : K -> L` is a norm K is a `numDomainType`. L is a                *)
(*       `lmodType K`. The HB class is `Norm`.                                *)
(*                                                                            *)
(******************************************************************************)
