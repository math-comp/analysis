...
Require Import Rbar Lub Markov (*H*)hierarchy.
Import ssrbool.
...
(* l1 = l2 = p_infty *)
  ...
  now exists 1 => ? /Rstruct.RltP.
  now exists (Rabs N) => ? /Rstruct.RltP.
  intros u v Hu Hv.
  simpl.
  apply HN.
  apply/Rstruct.RltP.
