...
(*                                                                            *)
(* `sup A`                                                                    *)
(*     ~ where `A : set R` with `R : realType`, the supremum of `A` when      *)
...
(*                                                                            *)
(* `Rint`                                                                     *)
(*     ~ the set of real numbers that can be written as `z%:~R`, i.e.,        *)
(*       as an integer                                                        *)
(*                                                                            *)
(* `Rtoint r`                                                                 *)
(*     ~ `r` when `r` is an integer, `0` otherwise                            *)
(*                                                                            *)
(* `floor_set x`                                                              *)
(*     ~ `[set y | Rtoint y /\ y <= x]`                                       *)
(*                                                                            *)
(* `Rfloor x`                                                                 *)
(*     ~ the floor of `x` as a real number                                    *)
(*                                                                            *)
(* `range1 x`                                                                 *)
(*     ~ `[set y |x <= y < x + 1]`                                            *)
(*                                                                            *)
(* `Rceil x`                                                                  *)
(*     ~ the ceil of `x` as a real number, i.e., `- Rfloor (- x)`             *)
(*                                                                            *)
(* `@rational R`                                                              *)
(*     ~ set of rational numbers of type `R : realType`                       *)
(*                                                                            *)
(* `@irrational R`                                                            *)
(*     ~ the complement of `rational R`                                       *)
(*                                                                            *)
(******************************************************************************)
