...
(*                                 filters                                    *)
(*  discrete_topology_pointed T == equips T with the discrete topology        *)
(*                 cantor_space == the Cantor space, with its canonical       *)
(*                                 metric                                     *)
(*                cantor_like T == perfect + compact + hausdroff +            *)
(*                                 zero dimensional                           *)
(*                     tree_of T == builds a topological tree with            *)
(*                                  levels (T n)                              *)
(*                                                                            *)
(******************************************************************************)
