...
(*                                   separates A and B when there is an       *)
(*                                   entourage separating them                *)
(*             Urysohn_normal A B == a continuous function T -> [0,1] which   *)
(*                                   separates A and B in a normal space      *)
(*                                   when closure A `&` closure B = set0      *)
