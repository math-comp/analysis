...
#[global] Hint Extern 0 (is_true (`|_ - ?x| < _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr_dist_lt end] : core.
#[global] Hint Extern 0 (is_true (`|?x - _| < _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr_distC_lt end] : core.
#[global] Hint Extern 0 (is_true (`|?x| < _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr0_norm_lt end] : core.
#[global] Hint Extern 0 (is_true (`|_ - ?x| <= _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr_dist_le end] : core.
#[global] Hint Extern 0 (is_true (`|?x - _| <= _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr_distC_le end] : core.
#[global] Hint Extern 0 (is_true (`|?x| <= _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: cvgr0_norm_le end] : core.
...
#[global] Hint Extern 0 (is_true (_ < ?x)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_right_gt end] : core.
#[global] Hint Extern 0 (is_true (?x < _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_left_lt end] : core.
#[global] Hint Extern 0 (is_true (?x != _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_right_neq end] : core.
#[global] Hint Extern 0 (is_true (?x != _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_left_neq end] : core.
#[global] Hint Extern 0 (is_true (_ < ?x)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_left_gt end] : core.
#[global] Hint Extern 0 (is_true (?x < _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_right_lt end] : core.
#[global] Hint Extern 0 (is_true (_ <= ?x)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_right_ge end] : core.
#[global] Hint Extern 0 (is_true (?x <= _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_left_le end] : core.
#[global] Hint Extern 0 (is_true (_ <= ?x)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_right_ge end] : core.
#[global] Hint Extern 0 (is_true (?x <= _)) => solve[match goal with
  H : x \is_near _ |- _ => near: x; now apply: nbhs_left_le end] : core.
