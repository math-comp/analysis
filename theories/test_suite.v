...
Require Import mathcomp.all.all boolp reals Rstruct Rbar classical_sets posnum topology normedtype.
...
check_join Choice.type Complete.type Complete.type.
check_join Choice.type CompleteNormedModule.type CompleteNormedModule.type.
...
check_join Choice.type Filtered.type Filtered.type.
...
check_join Choice.type NormedModule.type NormedModule.type.
...
check_join Choice.type Num.NormedZmodule.type Num.NormedZmodule.type.
...
check_join Choice.type Pointed.type Pointed.type.
check_join Choice.type Real.type Real.type.
check_join Choice.type SplittingField.type SplittingField.type.
check_join Choice.type Topological.type Topological.type.
check_join Choice.type Uniform.type Uniform.type.
check_join Choice.type UniformNormedZmodule.type UniformNormedZmodule.type.
check_join Choice.type Vector.type Vector.type.
check_join Complete.type Choice.type Complete.type.
check_join Complete.type Complete.type Complete.type.
check_join Complete.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Complete.type Equality.type Complete.type.
check_join Complete.type Filtered.type Complete.type.
check_join Complete.type GRing.Lmodule.type CompleteNormedModule.type.
check_join Complete.type GRing.Zmodule.type CompleteNormedModule.type.
check_join Complete.type NormedModule.type CompleteNormedModule.type.
check_join Complete.type Num.NormedZmodule.type CompleteNormedModule.type.
check_join Complete.type Pointed.type Complete.type.
check_join Complete.type Topological.type Complete.type.
check_join Complete.type Uniform.type Complete.type.
check_join CompleteNormedModule.type Choice.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Complete.type CompleteNormedModule.type.
check_join CompleteNormedModule.type CompleteNormedModule.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Equality.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Filtered.type CompleteNormedModule.type.
check_join CompleteNormedModule.type GRing.Lmodule.type CompleteNormedModule.type.
check_join CompleteNormedModule.type GRing.Zmodule.type CompleteNormedModule.type.
check_join CompleteNormedModule.type NormedModule.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Num.NormedZmodule.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Pointed.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Topological.type CompleteNormedModule.type.
check_join CompleteNormedModule.type Uniform.type CompleteNormedModule.type.
...
check_join Equality.type Complete.type Complete.type.
check_join Equality.type CompleteNormedModule.type CompleteNormedModule.type.
...
check_join Equality.type Filtered.type Filtered.type.
...
check_join Equality.type NormedModule.type NormedModule.type.
...
check_join Equality.type Num.NormedZmodule.type Num.NormedZmodule.type.
...
check_join Equality.type Pointed.type Pointed.type.
check_join Equality.type Real.type Real.type.
check_join Equality.type SplittingField.type SplittingField.type.
check_join Equality.type Topological.type Topological.type.
check_join Equality.type Uniform.type Uniform.type.
check_join Equality.type UniformNormedZmodule.type UniformNormedZmodule.type.
...
check_join Filtered.type Choice.type Filtered.type.
check_join Filtered.type Complete.type Complete.type.
check_join Filtered.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Filtered.type Equality.type Filtered.type.
check_join Filtered.type Filtered.type Filtered.type.
check_join Filtered.type GRing.Lmodule.type NormedModule.type.
check_join Filtered.type GRing.Zmodule.type UniformNormedZmodule.type.
check_join Filtered.type NormedModule.type NormedModule.type.
check_join Filtered.type Num.NormedZmodule.type UniformNormedZmodule.type.
check_join Filtered.type Pointed.type Filtered.type.
check_join Filtered.type Topological.type Topological.type.
check_join Filtered.type Uniform.type Uniform.type.
check_join Filtered.type UniformNormedZmodule.type UniformNormedZmodule.type.
...
check_join GRing.ClosedField.type Num.NormedZmodule.type Num.ClosedField.type.
...
check_join GRing.ComRing.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join GRing.ComRing.type Real.type Real.type.
...
check_join GRing.ComUnitRing.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join GRing.ComUnitRing.type Real.type Real.type.
...
check_join GRing.DecidableField.type Num.NormedZmodule.type Num.ClosedField.type.
...
check_join GRing.Field.type Num.NormedZmodule.type Num.NumField.type.
...
check_join GRing.Field.type Real.type Real.type.
...
check_join GRing.IntegralDomain.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join GRing.IntegralDomain.type Real.type Real.type.
...
check_join GRing.Lmodule.type Complete.type CompleteNormedModule.type.
check_join GRing.Lmodule.type CompleteNormedModule.type CompleteNormedModule.type.
...
check_join GRing.Lmodule.type Filtered.type NormedModule.type.
...
check_join GRing.Lmodule.type NormedModule.type NormedModule.type.
check_join GRing.Lmodule.type Num.NormedZmodule.type NormedModule.type.
check_join GRing.Lmodule.type Pointed.type NormedModule.type.
check_join GRing.Lmodule.type SplittingField.type SplittingField.type.
check_join GRing.Lmodule.type Topological.type NormedModule.type.
check_join GRing.Lmodule.type Uniform.type NormedModule.type.
check_join GRing.Lmodule.type UniformNormedZmodule.type NormedModule.type.
...
check_join GRing.Ring.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join GRing.Ring.type Real.type Real.type.
...
check_join GRing.UnitRing.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join GRing.UnitRing.type Real.type Real.type.
...
check_join GRing.Zmodule.type Complete.type CompleteNormedModule.type.
check_join GRing.Zmodule.type CompleteNormedModule.type CompleteNormedModule.type.
...
check_join GRing.Zmodule.type Filtered.type UniformNormedZmodule.type.
...
check_join GRing.Zmodule.type NormedModule.type NormedModule.type.
...
check_join GRing.Zmodule.type Num.NormedZmodule.type Num.NormedZmodule.type.
...
check_join GRing.Zmodule.type Pointed.type UniformNormedZmodule.type.
check_join GRing.Zmodule.type Real.type Real.type.
check_join GRing.Zmodule.type SplittingField.type SplittingField.type.
check_join GRing.Zmodule.type Topological.type UniformNormedZmodule.type.
check_join GRing.Zmodule.type Uniform.type UniformNormedZmodule.type.
check_join GRing.Zmodule.type UniformNormedZmodule.type UniformNormedZmodule.type.
check_join GRing.Zmodule.type Vector.type Vector.type.
check_join NormedModule.type Choice.type NormedModule.type.
check_join NormedModule.type Complete.type CompleteNormedModule.type.
check_join NormedModule.type CompleteNormedModule.type CompleteNormedModule.type.
check_join NormedModule.type Equality.type NormedModule.type.
check_join NormedModule.type Filtered.type NormedModule.type.
check_join NormedModule.type GRing.Lmodule.type NormedModule.type.
check_join NormedModule.type GRing.Zmodule.type NormedModule.type.
check_join NormedModule.type NormedModule.type NormedModule.type.
check_join NormedModule.type Num.NormedZmodule.type NormedModule.type.
check_join NormedModule.type Pointed.type NormedModule.type.
check_join NormedModule.type Topological.type NormedModule.type.
check_join NormedModule.type Uniform.type NormedModule.type.
check_join NormedModule.type UniformNormedZmodule.type NormedModule.type.
...
check_join Num.ArchimedeanField.type Num.NormedZmodule.type Num.ArchimedeanField.type.
...
check_join Num.ArchimedeanField.type Num.RealClosedField.type Real.type.
...
check_join Num.ArchimedeanField.type Real.type Real.type.
...
check_join Num.ClosedField.type Num.NormedZmodule.type Num.ClosedField.type.
...
check_join Num.NormedZmodule.type Choice.type Num.NormedZmodule.type.
check_join Num.NormedZmodule.type Complete.type CompleteNormedModule.type.
check_join Num.NormedZmodule.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Num.NormedZmodule.type Equality.type Num.NormedZmodule.type.
check_join Num.NormedZmodule.type Filtered.type UniformNormedZmodule.type.
check_join Num.NormedZmodule.type GRing.ClosedField.type Num.ClosedField.type.
check_join Num.NormedZmodule.type GRing.ComRing.type Num.NumDomain.type.
check_join Num.NormedZmodule.type GRing.ComUnitRing.type Num.NumDomain.type.
check_join Num.NormedZmodule.type GRing.DecidableField.type Num.ClosedField.type.
check_join Num.NormedZmodule.type GRing.Field.type Num.NumField.type.
check_join Num.NormedZmodule.type GRing.IntegralDomain.type Num.NumDomain.type.
check_join Num.NormedZmodule.type GRing.Lmodule.type NormedModule.type.
check_join Num.NormedZmodule.type GRing.Ring.type Num.NumDomain.type.
check_join Num.NormedZmodule.type GRing.UnitRing.type Num.NumDomain.type.
check_join Num.NormedZmodule.type GRing.Zmodule.type Num.NormedZmodule.type.
check_join Num.NormedZmodule.type NormedModule.type NormedModule.type.
check_join Num.NormedZmodule.type Num.ArchimedeanField.type Num.ArchimedeanField.type.
check_join Num.NormedZmodule.type Num.ClosedField.type Num.ClosedField.type.
check_join Num.NormedZmodule.type Num.NormedZmodule.type Num.NormedZmodule.type.
check_join Num.NormedZmodule.type Num.NumDomain.type Num.NumDomain.type.
check_join Num.NormedZmodule.type Num.NumField.type Num.NumField.type.
check_join Num.NormedZmodule.type Num.RealClosedField.type Num.RealClosedField.type.
check_join Num.NormedZmodule.type Num.RealDomain.type Num.RealDomain.type.
check_join Num.NormedZmodule.type Num.RealField.type Num.RealField.type.
check_join Num.NormedZmodule.type Order.Lattice.type Num.RealDomain.type.
check_join Num.NormedZmodule.type Order.POrder.type Num.NumDomain.type.
check_join Num.NormedZmodule.type Order.Total.type Num.RealDomain.type.
check_join Num.NormedZmodule.type Pointed.type UniformNormedZmodule.type.
check_join Num.NormedZmodule.type Real.type Real.type.
check_join Num.NormedZmodule.type Topological.type UniformNormedZmodule.type.
check_join Num.NormedZmodule.type Uniform.type UniformNormedZmodule.type.
check_join Num.NormedZmodule.type UniformNormedZmodule.type UniformNormedZmodule.type.
...
check_join Num.NumDomain.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join Num.NumDomain.type Real.type Real.type.
...
check_join Num.NumField.type Num.NormedZmodule.type Num.NumField.type.
...
check_join Num.NumField.type Real.type Real.type.
...
check_join Num.RealClosedField.type Num.ArchimedeanField.type Real.type.
check_join Num.RealClosedField.type Num.NormedZmodule.type Num.RealClosedField.type.
...
check_join Num.RealClosedField.type Real.type Real.type.
...
check_join Num.RealDomain.type Num.NormedZmodule.type Num.RealDomain.type.
...
check_join Num.RealDomain.type Real.type Real.type.
...
check_join Num.RealField.type Num.NormedZmodule.type Num.RealField.type.
...
check_join Num.RealField.type Real.type Real.type.
...
check_join Order.Lattice.type Num.NormedZmodule.type Num.RealDomain.type.
...
check_join Order.Lattice.type Real.type Real.type.
...
check_join Order.POrder.type Num.NormedZmodule.type Num.NumDomain.type.
...
check_join Order.POrder.type Real.type Real.type.
...
check_join Order.Total.type Num.NormedZmodule.type Num.RealDomain.type.
...
check_join Order.Total.type Real.type Real.type.
check_join Pointed.type Choice.type Pointed.type.
check_join Pointed.type Complete.type Complete.type.
check_join Pointed.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Pointed.type Equality.type Pointed.type.
check_join Pointed.type Filtered.type Filtered.type.
check_join Pointed.type GRing.Lmodule.type NormedModule.type.
check_join Pointed.type GRing.Zmodule.type UniformNormedZmodule.type.
check_join Pointed.type NormedModule.type NormedModule.type.
check_join Pointed.type Num.NormedZmodule.type UniformNormedZmodule.type.
check_join Pointed.type Pointed.type Pointed.type.
check_join Pointed.type Topological.type Topological.type.
check_join Pointed.type Uniform.type Uniform.type.
check_join Pointed.type UniformNormedZmodule.type UniformNormedZmodule.type.
check_join Real.type Choice.type Real.type.
check_join Real.type Equality.type Real.type.
check_join Real.type GRing.ComRing.type Real.type.
check_join Real.type GRing.ComUnitRing.type Real.type.
check_join Real.type GRing.Field.type Real.type.
check_join Real.type GRing.IntegralDomain.type Real.type.
check_join Real.type GRing.Ring.type Real.type.
check_join Real.type GRing.UnitRing.type Real.type.
check_join Real.type GRing.Zmodule.type Real.type.
check_join Real.type Num.ArchimedeanField.type Real.type.
check_join Real.type Num.NormedZmodule.type Real.type.
check_join Real.type Num.NumDomain.type Real.type.
check_join Real.type Num.NumField.type Real.type.
check_join Real.type Num.RealClosedField.type Real.type.
check_join Real.type Num.RealDomain.type Real.type.
check_join Real.type Num.RealField.type Real.type.
check_join Real.type Order.Lattice.type Real.type.
check_join Real.type Order.POrder.type Real.type.
check_join Real.type Order.Total.type Real.type.
check_join Real.type Real.type Real.type.
...
check_join Topological.type Choice.type Topological.type.
check_join Topological.type Complete.type Complete.type.
check_join Topological.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Topological.type Equality.type Topological.type.
check_join Topological.type Filtered.type Topological.type.
check_join Topological.type GRing.Lmodule.type NormedModule.type.
check_join Topological.type GRing.Zmodule.type UniformNormedZmodule.type.
check_join Topological.type NormedModule.type NormedModule.type.
check_join Topological.type Num.NormedZmodule.type UniformNormedZmodule.type.
check_join Topological.type Pointed.type Topological.type.
check_join Topological.type Topological.type Topological.type.
check_join Topological.type Uniform.type Uniform.type.
check_join Topological.type UniformNormedZmodule.type UniformNormedZmodule.type.
check_join Uniform.type Choice.type Uniform.type.
check_join Uniform.type Complete.type Complete.type.
check_join Uniform.type CompleteNormedModule.type CompleteNormedModule.type.
check_join Uniform.type Equality.type Uniform.type.
check_join Uniform.type Filtered.type Uniform.type.
check_join Uniform.type GRing.Lmodule.type NormedModule.type.
check_join Uniform.type GRing.Zmodule.type UniformNormedZmodule.type.
check_join Uniform.type NormedModule.type NormedModule.type.
check_join Uniform.type Num.NormedZmodule.type UniformNormedZmodule.type.
check_join Uniform.type Pointed.type Uniform.type.
check_join Uniform.type Topological.type Uniform.type.
check_join Uniform.type Uniform.type Uniform.type.
check_join Uniform.type UniformNormedZmodule.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Choice.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Equality.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Filtered.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type GRing.Lmodule.type NormedModule.type.
check_join UniformNormedZmodule.type GRing.Zmodule.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type NormedModule.type NormedModule.type.
check_join UniformNormedZmodule.type Num.NormedZmodule.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Pointed.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Topological.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type Uniform.type UniformNormedZmodule.type.
check_join UniformNormedZmodule.type UniformNormedZmodule.type UniformNormedZmodule.type.
