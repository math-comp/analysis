...
(* `x^'-, x^'+`                                                               *)
(*     ~ filters on real numbers for predicates s.t. `nbhs` holds on the      *)
(*       left/right of `x`                                                    *)
(*                                                                            *)
(* ## Normed topological abelian groups                                       *)
(* `pseudoMetricNormedZmodType R`                                             *)
(*     ~ interface type for a normed topological abelian group equipped       *)
(*       with a norm                                                          *)
(*     ~ the HB class is `PseudoMetricNormedZmod`                             *)
(*                                                                            *)
(* `NormedZmoduleMetric`                                                      *)
(*     ~ factory for `pseudoMetricNormedZmodType` based on metric             *)
(*       structures                                                           *)
(*                                                                            *)
(* ## Closed balls                                                            *)
(* `closed_ball_ norm x e`                                                    *)
(*     ~ `[set y | norm (x - y) <= e]`                                        *)
(*                                                                            *)
(* `closed_ball`                                                              *)
(*     ~ closure of a ball                                                    *)
(*                                                                            *)
(* ## Domination                                                              *)
(* `dominated_by h k f F`                                                     *)
(*     ~ `` `|f| <= k * `|h| ``, near `F`                                     *)
(*                                                                            *)
(* `strictly_dominated_by h k f F`                                            *)
(*     ~ `` `|f| < k * `|h| ``, near `F`                                      *)
(*                                                                            *)
(* `bounded_near f F`                                                         *)
(*     ~ `f` is bounded near `F`                                              *)
(*                                                                            *)
(* `[bounded f x | x in A]`                                                   *)
(*     ~ `f` is bounded on `A`, ie `F := globally A`                          *)
(*                                                                            *)
(* `[locally [bounded f x | x in A]`                                          *)
(*     ~ `f` is locally bounded on `A`                                        *)
(*                                                                            *)
(* `bounded_set`                                                              *)
(*     ~ set of bounded sets                                                  *)
...
(*                                                                            *)
(* `bounded_fun`                                                              *)
(*     ~ set of functions bounded on their whole domain                       *)
