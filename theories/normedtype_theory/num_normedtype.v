...
(*                                                                            *)
(* `pinfty_nbhs`                                                              *)
(*     ~ filter for `+oo` (for a `numFieldType`) Notation: `+oo`              *)
(*       (`ring_scope`)                                                       *)
(*                                                                            *)
(* `ninfty_nbhs`                                                              *)
(*     ~ filter for `-oo` (for a `numFieldType`) Notation: `-oo`              *)
...
(*                                                                            *)
(* `is_interval E`                                                            *)
(*     ~ the set `E` is an interval                                           *)
(*                                                                            *)
(* `bigcup_ointsub U q`                                                       *)
(*     ~ union of open real intervals included in `U` and that contain        *)
(*       the rational number `q`                                              *)
(*                                                                            *)
(* ``f @`[ a , b ], f @`] a , b [``                                           *)
(*     ~ notations for images of intervals, intended for continuous,          *)
(*       monotonous functions, defined in `ring_scope` and                    *)
(*       `classical_set_scope` respectively as:                               *)
(*     ~ ``f @`[ a , b ] := `[minr (f a) (f b), maxr (f a) (f b)]%O``         *)
(*     ~ ``f @`] a , b [ := `]minr (f a) (f b), maxr (f a) (f b)[%O``         *)
(*     ~ ``f @`[ a , b ] := `[minr (f a) (f b), maxr (f a) (f b)]%classic``   *)
(*     ~ ``f @`] a , b [ := `]minr (f a) (f b), maxr (f a) (f b)[%classic``   *)
(*                                                                            *)
(******************************************************************************)
