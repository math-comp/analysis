...
(* ## Normed modules                                                          *)
(* `normedModType K`                                                          *)
(*     ~ interface type for a normed module structure over the                *)
(*       `numDomainType` `K`                                                  *)
(*     ~ The HB class is `NormedModule`.                                      *)
(*                                                                            *)
(* `subNormedModType R V S`                                                   *)
(*     ~ join of `SubChoice`, `NormedModule`, `SubLmodule`,                   *)
(*       `SubNormedZmodule`, `SubConvexTvs`                                   *)
(*                                                                            *)
(* `normedVectType K`                                                         *)
(*     ~ interface type for a normed `vectType` structure over the            *)
(*       `numDomainType` `K`                                                  *)
(*     ~ The HB class is `NormedVector`.                                      *)
(*                                                                            *)
(* `` `|x| ``                                                                 *)
(*     ~ the norm of `x` (notation from `ssrnum.v`)                           *)
(*                                                                            *)
(* We endow `numFieldType` with the types of norm-related notions (accessible *)
(* with `Import numFieldNormedType.Exports`).                                 *)
(*                                                                            *)
(* `pseudoMetric_normed M`                                                    *)
(*     ~ an alias for the pseudometric structure defined from a               *)
(*       normed module `M : normedZmodType K` with `K : numFieldType`.        *)
(*                                                                            *)
(* `Lmodule_isNormed M`                                                       *)
(*     ~ factory for a normed module defined using an L-module `M`            *)
(*       over `R : numFieldType`                                              *)
(*                                                                            *)
(* `subLmodule_isSubNormedmodule R V S`                                       *)
(*     ~ light-weight factory that builds a `SubNormedmodule` given a         *)
(*       `SubLmodule` over a `normedModType`                                  *)
(* ## Hulls                                                                   *)
(* `Rhull A`                                                                  *)
(*     ~ the real interval hull of a set `A`                                  *)
(*                                                                            *)
(* ## Lipschitz functions                                                     *)
(* `self_sub f x`                                                             *)
(*     ~ `f x.1 - f x.2`                                                      *)
(*                                                                            *)
(* `lipschitz_on f F`                                                         *)
(*     ~ `f` is lipschitz near `F`                                            *)
(*                                                                            *)
(* `k.-lipschitz_on f F`                                                      *)
(*     ~ `f` is `k.-lipschitz` near `F`                                       *)
(*                                                                            *)
(* `k.-lipschitz_A f`                                                         *)
(*     ~ `f` is `k.-lipschitz` on `A`                                         *)
(*                                                                            *)
(* `k.-lipschitz f`                                                           *)
(*     ~ `k.-lipschitz_setT`                                                  *)
(*                                                                            *)
(* `[lipschitz f x | x in A]`                                                 *)
(*     ~ `f` is lipschitz on `A`                                              *)
(*                                                                            *)
(* `[locally [lipschitz f x | x in A]`                                        *)
(*     ~ `f` is locally lipschitz on `A`                                      *)
(*                                                                            *)
(* `[locally k.-lipschitz_A f]`                                               *)
(*     ~ `f` is locally `k.-lipschitz` on `A`                                 *)
(*                                                                            *)
(* `contraction q f`                                                          *)
(*     ~ `f` is `q.-lipschitz` and `q < 1`                                    *)
(*                                                                            *)
(* `is_contraction f`                                                         *)
(*     ~ exists `q`, `f` is `q.-lipschitz` and `q < 1`                        *)
(*                                                                            *)
(******************************************************************************)
