...
(*                                                                            *)
(* `cpoint A`                                                                 *)
(*     ~ the center of the set `A` when `A` is an open ball                   *)
(*                                                                            *)
(* `radius A`                                                                 *)
(*     ~ the radius of the set `A` when `A` is an open ball                   *)
(*     ~ `radius A` has type `{nonneg R}` with `R` a `numDomainType`          *)
(*                                                                            *)
(* `is_ball A`                                                                *)
(*     ~ boolean predicate that holds when `A` is an open ball                *)
(*                                                                            *)
(* ``k *` A``                                                                 *)
(*     ~ open ball with center `cpoint A` and radius `k * radius A`           *)
(*       when `A` is an open ball and `set0` o.w.                             *)
(*                                                                            *)
(* `vitali_collection_partition B V r n`                                      *)
(*     ~ subset of indices of `V` such the the ball `B i` has a               *)
(*       radius between `r/2^n+1` and `r/2^n`                                 *)
(*                                                                            *)
(******************************************************************************)
