...
(* `limf_esup f F, limf_einf f F`                                             *)
(*     ~ limit sup/inferior of `f` at "filter" `F`                            *)
(*     ~ `f` has type `X -> \bar R`.                                          *)
(*     ~ `F` has type `set_system X`.                                         *)
(*                                                                            *)
(* ## Lower semicontinuous                                                    *)
(* `lower_semicontinuous f`                                                   *)
(*     ~ the extended real-valued function `f` is lower-semicontinuous.       *)
(*       The type of `f` is `X -> \bar R` with `X : topologicalType`          *)
(*       and `R : realType`                                                   *)
(*                                                                            *)
(******************************************************************************)
