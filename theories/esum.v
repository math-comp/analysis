...
(*                                                                            *)
(* `fsets S`                                                                  *)
(*     ~ the set of finite sets (`fset`) included in `S`                      *)
(*                                                                            *)
(* `\esum_(i in I) f i`                                                       *)
(*     ~ summation of non-negative extended real numbers over classical       *)
(*       sets; `I` is a classical set and `f` is a function whose             *)
(*       codomain is included in the extended reals; it is `0` if             *)
(*       `I = set0` and `sup(\sum_A a)` where `A` is a finite set             *)
(*       included in `I` o.w.                                                 *)
(*                                                                            *)
(* `summable D f`                                                             *)
(*     ~ ``\esum_(x in D) `| f x | < +oo``                                    *)
