...
From mathcomp Require Import numfun lebesgue_integral kernel prob_lang.
...
Lemma letin'_sample_bernoulli d d' (T : measurableType d)
  ...
  r%:num%:E * u (true, x) y + (r%:num.~)%:E * u (false, x) y.
Proof.
rewrite letin'E/=.
...
Lemma exec_normalize_return g x r :
  ...
  (* NB: \d_r notation? *)
Proof.
by rewrite execD_normalize execP_return execD_real//=; exact: normalize_kdirac.
Qed.
