...
(* differentiable):                                                           *)
(* `'d f x`                                                                   *)
(*     ~ the differential of a function `f` at a point `x`                    *)
(*                                                                            *)
(* `differentiable f x`                                                       *)
(*     ~ the function `f` is differentiable at a point `x`                    *)
(*                                                                            *)
(* `'J f x`                                                                   *)
(*     ~ the Jacobian of `f` at a point `x`                                   *)
(*                                                                            *)
(* `'D_v f`                                                                   *)
(*     ~ the directional derivative of `f` along `v`                          *)
(*                                                                            *)
(* `derivable f a v`                                                          *)
(*     ~ the function `f` is derivable at `a` with direction `v`. The         *)
(*       type of `f` is `V -> W` with `V W : normedModType R` and             *)
(*       `R : numFieldType`                                                   *)
(*                                                                            *)
(* ``f^`()``                                                                  *)
(*     ~ the derivative of `f` of domain `R`                                  *)
(*                                                                            *)
(* ``f^`(n)``                                                                 *)
(*     ~ the nth derivative of `f` of domain `R`                              *)
(*                                                                            *)
