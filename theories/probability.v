...
apply: (@le_lt_trans _ _ 'E_P[(@normr _ _ \o X) * (@normr _ _ \o Y)]).
  ...
  rewrite (le_trans (le_abse_integral _ _ _))//.
    apply/measurable_EFinP/measurable_funM.
      by move/Lfun1_integrable : iX => /measurable_int.
...
- rewrite lte_mul_pinfty//.
  ...
  + rewrite expectation_fin_num//=.
    exact: Lfun_norm.
   move/Lfun_norm : iY => /expectation_fin_num.
   by rewrite fin_numElt => /andP[_].
...
move/Lfun1_integrable in iX.
move/Lfun1_integrable in iY.
...
have ? : P.-integrable [set: T] (EFin \o X^\+%R).
  rewrite -funerpos; apply/integrable_funepos => //.
  exact/Lfun1_integrable.
...
transitivity ('E_P[X^\+ * Y^\+] - 'E_P[X^\- * Y^\+]
              - 'E_P[X^\+ * Y^\-] + 'E_P[X^\- * Y^\-]).
  rewrite mulrDr !mulrDl -expectationB//=; last 2 first.
    exact/Lfun1_integrable.
    exact/Lfun1_integrable.
...
rewrite [in LHS]expectationM_ge0//=; last 2 first.
  ...
  rewrite mule_def_fin// expectation_fin_num//; exact/Lfun1_integrable.
rewrite [in LHS]expectationM_ge0//=; last 2 first.
...
transitivity ('E_P[X^\+ - X^\-] * 'E_P[Y^\+ - Y^\-]).
  rewrite -addeA -addeACA -muleBr; last 2 first.
    rewrite expectation_fin_num//; exact/Lfun1_integrable.
    rewrite fin_num_adde_defr// expectation_fin_num//.
    exact/Lfun1_integrable.
 rewrite -oppeB; last first.
    rewrite fin_num_adde_defr// fin_numM// expectation_fin_num//.
    exact/Lfun1_integrable.
    exact/Lfun1_integrable.
  ...
  rewrite -muleBl; last 2 first.
    rewrite fin_numB// !expectation_fin_num//.
    exact/Lfun1_integrable.
    exact/Lfun1_integrable.
    rewrite fin_num_adde_defr// expectation_fin_num//.
    exact/Lfun1_integrable.
