...
by rewrite /measure_of_charge EFinN mulN1e oppeK.
Qed.
...
rewrite jordan_decomp//= /crestr/= /cscale/= /crestr/=.
...
have ? : \int[mu]_(x in A) f x \is a fin_num.
  rewrite ge0_fin_numE// ?fin_num_measure// ?(lt_le_trans h)// ?leey//.
  exact: integral_ge0.
...
apply: cvgeB.
- rewrite adde_defC fin_num_adde_defl// ge0_fin_numE// ?measure_ge0//.
  by rewrite (le_lt_trans _ nufin)// le_measure// inE.
