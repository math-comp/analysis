...
(*                                                                            *)
(* `isSubProbability`                                                         *)
(*     ~ interface for functions that satisfy the property of                 *)
(*       subprobability. The HB class is `SubProbability`.                    *)
(*                                                                            *)
(* `subprobability T R`                                                       *)
(*     ~ subprobability measure over the `measurableType T` with values       *)
(*       in `\bar R` with `R : realType`. The HB class is                     *)
(*       `SubProbability`.                                                    *)
(*                                                                            *)
(* `Measure_isSubProbability`                                                 *)
(*     ~ interface that extends measures to subprobability measures           *)
(*                                                                            *)
(* `isProbability`                                                            *)
(*     ~ interface for functions that satisfy the property of                 *)
(*       probability measures. The HB class is `Probability`.                 *)
(*                                                                            *)
(* `probability T R`                                                          *)
(*     ~ type of probability measure over the `measurableType T` with         *)
(*       values in `\bar R` with `R : realType`                               *)
(*                                                                            *)
(* `Measure_isProbability`                                                    *)
(*     ~ interface that extends measures to probability measures              *)
(*                                                                            *)
(* `mnormalize mu`                                                            *)
(*     ~ normalization of a measure to a probability                          *)
(*                                                                            *)
(* `mset U r`                                                                 *)
(*     ~ the set of probability measures `mu` such that `mu U < r`            *)
(*                                                                            *)
(* `pset`                                                                     *)
(*     ~ the sets `mset U r` with `U` measurable and `r \in [0,1]`            *)
(*                                                                            *)
(* `pprobability`                                                             *)
(*     ~ the measurable type generated by `pset`                              *)
(******************************************************************************)
