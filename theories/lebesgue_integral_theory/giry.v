...
(*                                                                            *)
(* `m1 ≡μ m2`                                                                 *)
(*     ~ `m1 S = m2 S` for any measurable set `S`                             *)
(*                                                                            *)
(* `giry T R`                                                                 *)
(*     ~ the type of subprobability measures over `T`                         *)
(*                                                                            *)
(* `giry_ev P A`                                                              *)
(*     ~ the evaluation map `giryM T R -> [0, 1]`                             *)
(*                                                                            *)
(* `preimg_giry_ev A`                                                         *)
(*     ~ preimage of the sigma-algebra of extended real numbers via           *)
(*       the function `giry_ev ^~ A`                                          *)
(*                                                                            *)
(* `giry_measurable`                                                          *)
(*     ~ the sigma-algebra generated by the countable unions of               *)
(*       `preimg_giry_ev`                                                     *)
(*                                                                            *)
(* `giry_display`                                                             *)
(*     ~ display of `giry_measurable`                                         *)
(*                                                                            *)
(* `giry_int mu f`                                                            *)
(*     ~ `\int[mu]_x f x`                                                     *)
(*                                                                            *)
(* `giry_map mf`                                                              *)
(*     ~ the map of type `giry T1 R -> giry T2 R` where `mf` is a proof       *)
(*       that `f : T1 -> T2` is measurable                                    *)
(*                                                                            *)
(* `giry_ret x`                                                               *)
(*     ~ the unit of the Giry monad, i.e., `\d_x`                             *)
(*                                                                            *)
(* `@giry_join _ T R`                                                         *)
(*     ~ the multiplication of the Giry monad, of type                        *)
(*       `giry (giry T R) R -> giry T R`                                      *)
(*                                                                            *)
(* `giry_bind mu mf`                                                          *)
(*     ~ the bind with `mu : giry T1 R` and `f : T1 -> giry T2 R`             *)
(*                                                                            *)
(* `giry_prod`                                                                *)
(*     ~ product of type `giry T1 R * giry T2 R -> giry (T1 * T2) R`          *)
(*                                                                            *)
(******************************************************************************)
