...
(*     ~ the real number-valued function `f` is locally integrable on `D`     *)
(*                                                                            *)
(* `iavg f A`                                                                 *)
(*     ~ "average" of the real-valued function `f` over the set `A`           *)
(*                                                                            *)
(* `HL_maximal`                                                               *)
...
(*                                                                            *)
(* `davg f x r`                                                               *)
(*     ~ "deviated average" of the real-valued function `f` over              *)
(*       `ball x r`                                                           *)
(*                                                                            *)
(* `lim_sup_davg f x`                                                         *)
(*     ~ `lime_sup (davg f x) 0`                                              *)
(*                                                                            *)
(* `lebesgue_pt f x`                                                          *)
(*     ~ Lebesgue point at `x` of the real-valued function `f`                *)
(*                                                                            *)
(* `nicely_shrinking x E`                                                     *)
(*     ~ the sequence of sets `E` is nicely shrinking to `x`                  *)
(*                                                                            *)
(******************************************************************************)
