...
(* Detailed contents:                                                         *)
(* `{sfun T >-> R}`                                                           *)
(*     ~ type of simple functions; they form a (potentially zero) ring        *)
(*                                                                            *)
(* `{nnsfun T >-> R}`                                                         *)
(*     ~ type of non-negative simple functions                                *)
(*                                                                            *)
(* `indic_sfun mD`                                                            *)
(*     ~ `mindic _ mD`                                                        *)
(*                                                                            *)
...
(*                                                                            *)
(* `proj_nssfun f mA`                                                         *)
(*     ~ projection of the function `f` to the set `A`; `mA` is a proof       *)
(*       that `A` is measurable                                               *)
(*                                                                            *)
(* `scale_nnsfun k f`                                                         *)
(*     ~ scales `f` by the non-negative real number `k`                       *)
(*                                                                            *)
(* `sum_nnsfun f n`                                                           *)
(*     ~ `\big[add_nnsfun/nnsfun0]_(i < n) f i`                               *)
(*                                                                            *)
(* `bigmax_nnsfun f n`                                                        *)
(*     ~ `\big[max_nnsfun/nnsfun0]_(i < n) f i`                               *)
(*                                                                            *)
(******************************************************************************)
