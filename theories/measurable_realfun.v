...
(*     ~ generator of the completed Lebesgue sigma-algebra                    *)
(*                                                                            *)
(* `ps_infty`                                                                 *)
(*     ~ inductive definition of the powerset `{0, {-oo}, {+oo}, {-oo,+oo}}`  *)
(*                                                                            *)
(* `emeasurable G`                                                            *)
(*     ~ sigma-algebra over `\bar R` built out of the measurables `G` of a    *)
...
(*                                                                            *)
(* `mindic mD`                                                                *)
(*     ~ `\1_D`, where `mD` is a proof that `D` is measurable                 *)
(*                                                                            *)
(* `indic_mfun mD`                                                            *)
(*     ~ `mindic mD`                                                          *)
(*                                                                            *)
