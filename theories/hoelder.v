...
Proof.
by move=> x0; rewrite ler_subl_addl ler_addr.
Qed.
...
pose q := p / (p - 1).
have q1 : 1 <= q.
 by rewrite /q ler_pdivl_mulr// ?mul1r ?lerBr// subr_gt0 lt_neqAle eq_sym pn1.
...
- by rewrite nnegrE addr_ge0// mulr_ge0/w2/w1 ?onem_ge0.
