...
(*                                                                            *)
(* `beta_fun a b`                                                             *)
(*     ~ ``\int[mu]_x (XMonemX a.-1 b.-1 \_`[0,1] x)``                        *)
(*                                                                            *)
(* `beta_pdf`                                                                 *)
(*     ~ probability density function for beta                                *)
(*                                                                            *)
(* `beta_prob`                                                                *)
(*     ~ beta probability measure                                             *)
(*                                                                            *)
(* `div_beta_fun a b c d`                                                     *)
(*     ~ `beta_fun (a + c) (b + d) / beta_fun a b`                            *)
(*                                                                            *)
(* `beta_prob_bernoulli_prob a b c d U`                                       *)
(*     ~ `\int[beta_prob a b]_(y \in [0, 1]) bernoulli_prob (XMonemX c d) U`  *)
(*                                                                            *)
(******************************************************************************)
