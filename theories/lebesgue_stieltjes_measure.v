...
(*                                                                            *)
(* `cumulative R`                                                             *)
(*     ~ type of non-decreasing, right-continuous functions (with             *)
(*       `R : numFieldType`). The HB class is `Cumulative`. instance:         *)
(*       `idfun`                                                              *)
(*                                                                            *)
(* `cumulativeBounded R l r`                                                  *)
(*     ~ type of cumulative functions `f` such that `f @ -oo --> l` and       *)
(*       `f @ +oo --> r`. The HB class is `CumulativeBounded`                 *)
(*                                                                            *)
...
(* `ocitv_type R`                                                             *)
(*     ~ alias for `R : realType`                                             *)
(*                                                                            *)
(* `ocitv`                                                                    *)
(*     ~ set of open-closed intervals `]x, y]` where `x` and `y` are real     *)
(*       numbers                                                              *)
(*                                                                            *)
(* `R.-ocitv`                                                                 *)
(*     ~ display for `ocitv_type R`                                           *)
(*                                                                            *)
(* `R.-ocitv.-measurable`                                                     *)
(*     ~ semiring of sets of open-closed intervals                            *)
(*                                                                            *)
(* `open_type R`                                                              *)
(*     ~ alias for `R : realType`                                             *)
(*                                                                            *)
(* `R.-open`                                                                  *)
(*     ~ `sigma_display (@open R)`                                            *)
(*                                                                            *)
(* `R.-open.-measurable`                                                      *)
(*     ~ sigma-algebra generated by open sets                                 *)
...
(* definitions:                                                               *)
(* `measurableTypeR R`                                                        *)
(*     ~ `measurableType` generated by `R.-ocitv` or `R.-open`                *)
(*                                                                            *)
(* `@lebesgue_display R`                                                      *)
(*     ~ `(measure_)display` for the sigma-algebra generated by               *)
(*       `R.-ocitv` or `R.-open`                                              *)
(*                                                                            *)
(* `@measurableR R`                                                           *)
(*     ~ measurable sets generated by `R.-ocitv` or `R.-open`                 *)
(* The module `MeasurableR` contains the default sigma-algebra, which is      *)
(* `MeasurableRopen`. The latter contains in addition:                        *)
(* `ocitv_measure mu`                                                         *)
(*     ~ measure over the sigma-algebra generated by open sets built          *)
(*       out of `mu`, the same measure over the sigma-algebra generated       *)
(*       by `ocitv`                                                           *)
(* The last part of the file contains the construction of the Lebesgue-       *)
(* Stieltjes measure:                                                         *)
(* `wlength f A`                                                              *)
(*     ~ `f b - f a` with the hull of the set of real numbers `A` being       *)
(*       delimited by `a` and `b`                                             *)
(*                                                                            *)
(* `ocitv_lebesgue_stieltjes_measure f`                                       *)
(*     ~ Lebesgue-Stieltjes measure for `f`. `f` is a cumulative              *)
(*       function. The sigma algebra is generated from `ocitv`                *)
(*                                                                            *)
(* `lebesgue_stieltjes_measure f`                                             *)
(*     ~ Lebesgue-Stieltjes measure for `f`. `f` is a cumulative              *)
(*       function. The sigma algebra is generated from open sets              *)
(*                                                                            *)
(* `completed_lebesgue_stieltjes_measure f`                                   *)
(*     ~ the completed Lebesgue-Stieltjes measure                             *)
(*                                                                            *)
(******************************************************************************)
