...
(*                                                                            *)
(* `initial_topology f`                                                       *)
(*     ~ initial topology by a function `f : S -> T` on `S`. `S` must be a    *)
(*       `choiceType` and `T` a `topologicalType`                             *)
(*                                                                            *)
(* `sub_initial_topology V S U`                                               *)
(*     ~ sub-initial topology generated by the `\val : U -> V`. `U`           *)
(*       has type `subChoiceType S` with `S : pred V`. This is a              *)
(*       `subTopologicalType` when `V` is endowed with a topology.            *)
(*       This is a `subConvexTvsType` when `V` is endowed with a              *)
(*       `convexTvsType` (and when `U` is `subLmodType`)                      *)
