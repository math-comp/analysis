...
(* ### Uniform                                                                *)
(* `nbhs_ ent`                                                                *)
(*     ~ neighborhoods defined using entourages                               *)
(*                                                                            *)
(* `uniformType`                                                              *)
(*     ~ interface type for uniform spaces: a type equipped with              *)
(*       entourages                                                           *)
(*     ~ the HB class is `Uniform`                                            *)
(*                                                                            *)
(* `puniformType`                                                             *)
(*     ~ a pointed and uniform space                                          *)
(*                                                                            *)
(* `entourage`                                                                *)
(*     ~ set of entourages in a uniform space                                 *)
(*                                                                            *)
(* `split_ent E`                                                              *)
(*     ~ when `E` is an entourage, `split_ent E` is an entourage `E'`         *)
(*       such that `E' \o E'` is included in `E` when seen as a               *)
(*       relation                                                             *)
(*                                                                            *)
(* `countable_uniformity T`                                                   *)
(*     ~ `T`'s entourage has a countable base                                 *)
(*     ~ this is equivalent to `T` being metrizable                           *)
(*                                                                            *)
(* `unif_continuous f`                                                        *)
...
(* `cauchy F`                                                                 *)
(*     ~ the set of sets `F` is a cauchy filter (entourage                    *)
(*       definition)                                                          *)
(*                                                                            *)
(* `completeType`                                                             *)
(*     ~ interface type for a complete uniform space structure                *)
