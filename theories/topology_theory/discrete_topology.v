...
(* # Discrete Topology                                                        *)
(* `discreteNbhsType`                                                         *)
(*     ~ neighborhoods are principal filters                                  *)
(*                                                                            *)
(* `discrete_ent`                                                             *)
(*     ~ entourages of the discrete uniformity topology, equipped with        *)
(*       the `Uniform` structure                                              *)
(*                                                                            *)
(* `discrete_ball`                                                            *)
(*     ~ singleton balls for the discrete metric, equipped with the           *)
(*       `Uniform` structure                                                  *)
(*                                                                            *)
(* `discreteTopologicalType`                                                  *)
(*     ~ types with a discrete topology                                       *)
(*                                                                            *)
(* `discreteOrderTopologicalType`                                             *)
(*     ~ an order type with the discrete topology                             *)
(*                                                                            *)
(* `pdiscreteTopologicalType`                                                 *)
(*     ~ pointed type with the discrete topology                              *)
(*                                                                            *)
(* `pdiscreteOrderTopologicalType`                                            *)
(*     ~ pointed, ordered, and discrete                                       *)
(*                                                                            *)
(* `discreteUniformType`                                                      *)
(*     ~ a uniform space where the diagonal is an entourage                   *)
(*                                                                            *)
(* `discretePseudoMetricType`                                                 *)
(*     ~ a pseudometric space where the only balls are singletons             *)
(*                                                                            *)
(* `discrete_topology T`                                                      *)
(*     ~ alias attaching discrete structures for topology, uniformity,        *)
(*       and pseudometric                                                     *)
(******************************************************************************)
