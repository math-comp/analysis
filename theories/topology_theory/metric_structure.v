...
(*                                                                            *)
(* `metricType K`                                                             *)
(*     ~ metric structure with distance `mdist` The HB class is               *)
(*       `Metric`. `R^o` with `R : numFieldType` is shown to be a             *)
(*       metric space. The mixin `PseudoMetric_isMetric` extends              *)
(*       `PseudoMetric`. The factor `isMetric` just requires a                *)
(*       distance.                                                            *)
(******************************************************************************)
