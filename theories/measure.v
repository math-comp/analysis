...
(**md monotone ring implies sigma-ring *)
...
(**md see Theorem B (section 6) in Paul Halmos' Measure Theory text book, p.27 *)
...
have K_monotone F : (*K(F) !=set0 ->*) monotone (K(F)).
  split.
...
rewrite eqEsubset; split.
  apply: smallest_sub.
    exact: g_sigma_ring_monotone.
  exact: sub_sigma_ring.
