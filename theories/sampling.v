...
- apply: eq_measure_integral => A mA _ /=.
  by rewrite /pushforward /phi/= thead_behead_preimage.
- exact: measurableT.
...
- rewrite /=.
  ...
  apply/integrableP; split => /=.
    by apply: measurableT_comp => //=; exact: mphi.
  ...
  - apply/measurable_EFinP => //=; apply: measurableT_comp => //=.
    by apply: measurableT_comp => //=; [exact/measurable_EFinP|exact: mphi].
  ...
  - apply: le_integrable => //=.
    + apply: measurableT_comp => //=; last exact: mpsi.
      apply/measurable_EFinP => //=; apply: measurableT_comp => //=.
      by apply: measurableT_comp => //=; [exact/measurable_EFinP|exact: mphi].
    + by move=> x _; rewrite normr_id// psiK.
- exact: measurableT.
Qed.
