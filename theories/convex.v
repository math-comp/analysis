...
(*     ~ quasi-associativity of the operator of convex spaces                 *)
(*                                                                            *)
(* `isConvexSpace R T`                                                        *)
(*     ~ interface for convex spaces with `R : numDomainType`. The HB         *)
(*       class is `ConvexSpace`.                                              *)
(*                                                                            *)
(* `a <| t |> b`                                                              *)
(*     ~ convexity operator                                                   *)
(*                                                                            *)
...
(* `convex_lmodType E`                                                        *)
(*     ~ `E : lmodType R` as a convex space                                   *)
(*                                                                            *)
(* `convex_numDomainType R`                                                   *)
(*     ~ `R : numDomainType` as a convex space                                *)
(*                                                                            *)
(* `convex_set A`                                                             *)
(*     ~ `A : set M` is a convex set; `M` is an Lmodule over                  *)
(*       `R : numDomainType`                                                  *)
(*                                                                            *)
(* `convex_function f`                                                        *)
(*     ~ `f : E -> R` is a convex function; `E` is an Lmodule over            *)
(*       `R : numFieldType`                                                   *)
(******************************************************************************)
