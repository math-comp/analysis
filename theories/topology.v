...
move=> n IH m x y z d1 d2 Oxy [w] [e1] [e2] [Oyw ? ? ? <-]. 
...
by exists t; exists e3; exists e4; split.
Qed.
...
case: (pselect (e2 <= d2)).
  move=> e2d2; exists y; exists z; exists n.+1; exists 0%N; split.
...
apply: splitG3; exists x2 => //; last exists x3 => //.
