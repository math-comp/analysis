...
(*                   ProperFilter F == notation for ProperFilter' F.          *)
...
(*       prove that the intersection of some family (H_i)_i is in F. The      *)
(*       tactic end_near replaces this goal with several subgoals of the form *)
(*       \forall x \near F, H_i x. Ideally, these subgoals should be trivial. *)
